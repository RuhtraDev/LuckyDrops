(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["RingTracker"] = factory((function webpackLoadOptionalExternalModule() { try { return require("sharp"); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return require("canvas"); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return require("electron/common"); } catch(e) {} }()));
	else
		root["RingTracker"] = factory(root["sharp"], root["canvas"], root["electron/common"]);
...
.modal-footer {
    ...
    background-image: url('https://runeapps.org/nis/alt1-currentskin/background.png') !important;
    background-color: #a8a8a85e !important;
...
.total {
    ...
    padding: 50px;
    text-align: center;
    background: linear-gradient(180deg, #1a1a1a00 80%, #f1ad1b86 100%);
...
.text-muted {
    ...
    /* Ou qualquer outra cor que preferir */
}
.modal-content {
...
var DEV_MODE = !window.alt1;
if (DEV_MODE) {
    console.log("🔧 MODO DESENVOLVIMENTO: Rodando fora do Alt1");
    console.log("✅ Chamadas à API Alt1 serão ignoradas");
    // Mock da API Alt1 para evitar erros
    window.alt1 = window.alt1 || {
        identifyAppUrl: function () { },
...
// Elementos DOM com type assertions corretas
...
var appColor = alt1__WEBPACK_IMPORTED_MODULE_0__.mixColor(0, 255, 255); // Ciano para overlay
var timestampRegex = /\[\d{2}:\d{2}:\d{2}\]/g;
var reader = new (alt1_chatbox__WEBPACK_IMPORTED_MODULE_1___default())();
var appName = "RingTracker";
// Regex para capturar drops dos anéis
var ringRegexes = {
...
reader.readargs = {
    colors: [
        alt1__WEBPACK_IMPORTED_MODULE_0__.mixColor(245, 124, 1), // Laranja para LOTD
        alt1__WEBPACK_IMPORTED_MODULE_0__.mixColor(255, 215, 0), // Dourado para Hazelmere
    ],
};
...
window.setTimeout(function () {
    var findChat = setInterval(function () {
        if (reader.pos === null) {
            ...
            // Mostrar overlay do chat selecionado
            showSelectedChat(reader.pos);
...
exportButton.addEventListener("click", function () {
    ...
    if (mode === "total") {
        ...
        filename = "RingTracker_Totals.csv";
    }
    else {
        // Exportar histórico
        ...
        filename = "RingTracker_History.csv";
    }
...
function showSelectedChat(chat) {
    ...
    try {
        if (window.alt1) {
            ...
            console.log("🔧 [DEV] Overlay do chat seria mostrado aqui:", chat.mainbox.rect);
        }
    }
    catch (e) {
        if (DEV_MODE) {
            console.log("🔧 [DEV] Overlay ignorado:", e);
        }
        else {
...
function updateSaveData() {
    ...
    datasets.forEach(function (data) {
        ...
        var value = data[key];
        if (key === "data") {
            // Array de dados - adicionar novo item
            if (!current[key])
                current[key] = [];
